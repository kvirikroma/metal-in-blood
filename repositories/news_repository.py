...
def add_post(post: NewsPost):
    database.session.add(post)
    database.session.commit()
    return post


def delete_post(post: NewsPost):
    database.session.delete(post)
    database.session.commit()


def find_posts_by_author(author: str, page: int, page_size: int):
...
def search_posts(text_to_search: str, page: int, page_size: int):
...
def get_newest_posts(page: int, page_size: int):
